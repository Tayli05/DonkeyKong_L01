...
#include "DonkeyKong_L01/Jugador.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	DONKEYKONG_L01_API UClass* Z_Construct_UClass_AJugador();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AJugador_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AJugador_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UIAdapter_NoRegister, (int32)VTABLE_OFFSET(AJugador, IIAdapter), false },
		};
	...
	IMPLEMENT_CLASS(AJugador, 2723694166);
	template<> DONKEYKONG_L01_API UClass* StaticClass<AJugador>()
	{
		return AJugador::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AJugador(Z_Construct_UClass_AJugador, &AJugador::StaticClass, TEXT("/Script/DonkeyKong_L01"), TEXT("AJugador"), false, nullptr, nullptr, nullptr);
